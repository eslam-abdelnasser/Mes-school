...
@section('css')
    ...
    {{Html::style('admin-panel/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css')}}
    {{--<link href="../assets/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />--}}
    {{Html::style('admin-panel/assets/global/plugins/morris/morris.css')}}
    {{--<link href="../assets/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />--}}
    {{Html::style('admin-panel/assets/global/plugins/fullcalendar/fullcalendar.min.css')}}
    {{--<link href="../assets/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />--}}
    {{Html::style('admin-panel/assets/global/plugins/jqvmap/jqvmap/jqvmap.css')}}
@endsection
@section('content')
...
@section('js')
    ...
    {{ Html::script('admin-panel/assets/global/plugins/counterup/jquery.waypoints.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/counterup/jquery.counterup.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/amcharts.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/serial.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/pie.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/radar.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/themes/light.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/themes/patterns.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amcharts/themes/chalk.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/ammap/ammap.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/amcharts/amstockcharts/amstock.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/fullcalendar/fullcalendar.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/horizontal-timeline/horizontal-timeline.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/flot/jquery.flot.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/flot/jquery.flot.resize.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/flot/jquery.flot.categories.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jquery.sparkline.min.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js')}}
    {{ Html::script('admin-panel/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js')}}
@endsection