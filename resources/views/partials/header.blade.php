...
<head>
    ...
    {{Html::style('admin-panel/assets/layouts/layout/css/layout-rtl.min.css')}}
    {{--<link href="../assets/layouts/layout/css/themes/darkblue-rtl.min.css" rel="stylesheet" type="text/css" id="style_color" />--}}
    {{Html::style('admin-panel/assets/layouts/layout/css/themes/darkblue-rtl.min.css')}}
    {{--<link href="../assets/layouts/layout/css/custom-rtl.min.css" rel="stylesheet" type="text/css" />--}}
    {{Html::style('admin-panel/assets/layouts/layout/css/custom-rtl.min.css')}}
